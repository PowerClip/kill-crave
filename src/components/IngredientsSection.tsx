    ...
    <SectionGradient id="ingredients" className="py-28">
      <div className="container mx-auto max-w-6xl px-4 sm:px-8 text-white">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <div className="relative w-full max-w-xl mb-10 overflow-hidden rounded-[32px] border border-white/15 backdrop-blur-sm p-4 sm:p-6 bg-white/5">
          ...
          <div className="mt-10 text-left w-full bg-white/8 border border-white/12 rounded-3xl p-6 sm:p-8 backdrop-blur-sm">
