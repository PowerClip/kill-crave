...
const ProofSection = () => {
  return (
    <SectionGradient className="py-24 sm:py-32 text-black">
      <div className="container mx-auto px-4 sm:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center max-w-7xl mx-auto">
          {/* Visual Demo */}
          <div className="space-y-12">
            <div className="bg-white/70 rounded-3xl p-8 sm:p-12 shadow-card border border-black/10 backdrop-blur">
              <H3 className="text-3xl sm:text-4xl font-normal mb-10 text-center tracking-wide text-black">Le Moment Magique</H3>
              ...
              <div className="flex items-center justify-center space-x-12 mb-10">
                <div className="text-center space-y-4">
                  ...
                  <P className="text-sm text-black/70 font-medium">Avant Kill Crave</P>
                ...
                <div className="text-center space-y-4">
                  <div className="w-20 h-20 bg-white/50 rounded-full flex items-center justify-center text-3xl mb-3 shadow-soft">
                    📄
                  </div>
                  <P className="text-sm text-black/70 font-medium">Après Kill Crave</P>
              ...
              <img 
                ...
                className="w-full h-64 object-cover rounded-2xl shadow-soft border border-black/10"
              />
            </div>
          </div>
          ...
          <div className="space-y-12 lg:pl-8">
            <div className="space-y-8">
              <H2 className="text-5xl lg:text-6xl font-normal leading-tight text-black">
                Blocage instantané,
                <span className="block font-medium italic text-tertiary drop-shadow-lg">Attitude Blackout</span>
              </H2>
              <P className="text-2xl text-black/75 leading-relaxed">
            ...
            <div className="bg-white/70 rounded-3xl p-8 shadow-card border border-black/10 backdrop-blur">
              <div className="flex items-start space-x-6">
                ...
                <div className="space-y-3">
                  <H3 className="text-2xl font-normal tracking-wide text-black">Étudié Cliniquement</H3>
            ...
            <div className="bg-white/70 rounded-3xl p-8 shadow-card border border-black/10 backdrop-blur">
              <div className="flex items-start space-x-6">
                ...
                <div className="space-y-3">
                  <H3 className="text-2xl font-normal tracking-wide text-black">Naturel & Sûr</H3>
                  <P className="text-lg text-black/75 leading-relaxed">
