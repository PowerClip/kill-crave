...
const SolutionSection = () => {
  return (
  <SectionGradient id="solution" className="py-24 sm:py-28 text-white">
      <div className="container mx-auto px-4 sm:px-8 max-w-6xl">
        {/* Title + paragraph */}
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          <Badge className="rounded-full px-3 py-1 tracking-[0.18em] uppercase bg-white/10 text-white ring-1 ring-white/20">Pourquoi Kill Crave</Badge>
          <H2 className="mt-4 font-normal leading-tight text-white">
