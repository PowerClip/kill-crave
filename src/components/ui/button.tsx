  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-accent text-primary font-serif font-medium hover:opacity-90 hover:scale-[1.02] shadow-hero transition-all duration-300",
        premium: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-card hover:shadow-hero font-medium",
        soft: "bg-accent-warm text-primary hover:bg-accent-peach transition-smooth shadow-soft hover:shadow-card",
      },
      size: {
