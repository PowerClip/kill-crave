            ...
            <CardContent className="p-6 md:p-8 space-y-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      Contactez-nous ensuite à support@kill-crave.com avec votre numéro de commande.
                    </p>
                  </div>
                  <div>
              ...
              <div className="p-6 bg-secondary rounded-lg">
                ...
                <div className="space-y-2 text-muted-foreground">
                  ...
                  <p><strong>Email :</strong> <a href="mailto:support@kill-crave.com" className="text-primary hover:underline">support@kill-crave.com</a></p>
